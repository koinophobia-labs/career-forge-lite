...
const ready = { ...selected, dossier: { ...empty.dossier, evidence, approvedClaims: evidence.map((item) => item.detail), roles: [{ id: "role-northstar", title: "Support Specialist", employer: "Northstar", startDate: "2021", endDate: "2026", current: false, responsibilities: [evidence[1].detail], tools: [], outcomes: [evidence[2].detail], evidenceIds: evidence.map((item) => item.id) }], responsibilities: [evidence[1].detail], metrics: [evidence[2].detail], proofPoints: [evidence[2].detail], updatedAt: NOW } };
