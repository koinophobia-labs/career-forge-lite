...
check("home: no competing marketing landing page", !home.includes("Your career is bigger than your last résumé.") && home.indexOf("<IntentRouter />") < home.indexOf("How Career Forge stays honest"));
