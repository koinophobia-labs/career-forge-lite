  ...
  return (
    <section className="trust-panel mt-8 overflow-hidden p-5 sm:p-6" aria-labelledby="pack-ready-title">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div><p className="trust-kicker text-xs font-bold uppercase">Generation complete</p><h2 id="pack-ready-title" className="mt-2 text-3xl font-bold text-paper">Your Résumé Pack is ready.</h2><p className="mt-2 text-sm text-paper/65">{pack.lanePacks.length} active lane{pack.lanePacks.length === 1 ? "" : "s"} · {pack.variants.length} generated résumés · {pack.receipt.evidenceUsed.length} approved evidence items traced · {uniqueUnclaimed.length} unique gaps or unsupported claims left unclaimed</p></div>
