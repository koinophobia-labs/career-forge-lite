    ...
    <main>
      ...
      <section className="mx-auto max-w-3xl px-5 py-10 sm:px-8">
        ...
        <div className="mt-8 space-y-8 text-sm leading-7 text-paper/75">
          ...
          <section><h2 className="text-lg font-bold text-paper">Free access and self-service packs</h2><p className="mt-2">Free access includes local career-history entry or import, evidence review, one active role direction, editable draft previews, job analysis, application tracking, and a limited interview preview. Paid packs unlock the specific exports, workflows, and role-direction limits shown at checkout: $9 Resume Pack, $15 Job Pack, $25 Career Pack, or $39 30-Day All Access.</p><p className="mt-2">Resume, Job, and Career Packs are one-time purchases with no automatic renewal. 30-Day All Access is also a one-time purchase and expires 30 days after Stripe records the purchase; it does not renew automatically. Previously downloaded files and local career data remain yours after access expires. If payment succeeds but access is not delivered, contact <a href="mailto:koinophobia999@gmail.com" className="text-cyan underline hover:text-gold">koinophobia999@gmail.com</a> with the Stripe receipt reference.</p></section>
          ...
          <section>
            <h2 className="text-lg font-bold text-paper">Separate optional human résumé service</h2>
