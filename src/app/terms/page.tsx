    ...
    <main>
      ...
      <section className="mx-auto max-w-3xl px-5 py-10 sm:px-8">
        ...
        <div className="mt-8 space-y-8 text-sm leading-7 text-paper/75">
          ...
          <section><h2 className="text-lg font-bold text-paper">Career Pack purchases and access</h2><p className="mt-2">Paid Career Packs are one-time purchases, not subscriptions. A purchase issues a personal access code that activates the stated pack features. Do not publish, transfer, or resell a code. Payments are processed by Stripe. The exact tier scope shown at checkout controls the purchase.</p><p className="mt-2">If payment succeeds but the code is not delivered or does not activate, contact <a href="mailto:koinophobia999@gmail.com" className="text-cyan underline hover:text-gold">koinophobia999@gmail.com</a> with the Stripe receipt reference.</p></section>
