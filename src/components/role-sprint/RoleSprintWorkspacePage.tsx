...
function RoleSprintWorkspace() {
  ...
  function submitWork(record: RoleSprintRecord) {
    setSubmitError(null);
    const artifactValidation = validateSprintArtifact(record.userWork, record.sprintType);
    if (!artifactValidation.ok) {
      setSubmitError(artifactValidation.error);
      return;
    }
...
export function RoleSprintWorkspacePage() {
  return (
    <main id="main">
